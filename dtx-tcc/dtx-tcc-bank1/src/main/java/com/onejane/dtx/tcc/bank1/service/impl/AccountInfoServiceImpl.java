package com.onejane.dtx.tcc.bank1.service.impl;

import com.onejane.dtx.tcc.bank1.dao.AccountInfoDao;
import com.onejane.dtx.tcc.bank1.service.AccountInfoService;
import com.onejane.dtx.tcc.bank1.spring.Bank2Client;
...
public class AccountInfoServiceImpl implements AccountInfoService {
    ...
    public void updateAccountBalance(String accountNo, Double amount) {
        ...
        //try幂等判断 判断local_try_log表中是否有try日志记录，如果有则不再执行
